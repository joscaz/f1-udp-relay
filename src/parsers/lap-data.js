...
function parseLapData(buf) {
  ...
  for (let i = 0; i < 22; i++) {
    ...
    // offset + 40: cornerCuttingWarnings (not forwarded yet)
    // offset + 41: numUnservedDriveThroughPenalties
    // offset + 42: numUnservedStopGoPenalties
    ...
    // offset + 51: pitStopShouldServePen (not forwarded yet)
    const speedTrapFastestSpeed = buf.readFloatLE(offset + 52);
    // offset + 56: speedTrapFastestLap (not forwarded yet)
