...
function parseSession(buf) {
  ...
  // Skip sliProNativeSupport (1) + numMarshalZones (1) + marshalZones (21 * 5 = 105)
  ...
  // Skip numWeatherForecastSamples (1) + weatherForecastSamples (64 * 8 = 512) + forecastAccuracy (1) + aiDifficulty (1) + 3 linkIdentifiers (4*3=12)
